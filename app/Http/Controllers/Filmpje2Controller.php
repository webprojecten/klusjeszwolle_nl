...
class Filmpje2Controller extends Controller
{
    ...
    public function show()
    {
        $clip = [
            0 => [
                'pop' => 'f:/img/21.jpg top:0 left:0 d:100',
            ...
            6000 => [
                ...
                'zoom' => 'bottom:10 left:10 size:150 d:3000',
            ],
            9000 => [
                'clipEnd' => 'stay',
            ]
        ...
        foreach ($clip as $time => $actions) { # n = moments
            $perc = round($time / $clipDuration * 100, 2);
            $this->addCssPerc(strval($perc));
            foreach ($actions as $action => $value) { # n = events
